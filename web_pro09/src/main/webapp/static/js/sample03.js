...
function f4(){
	// 사용자 입력값을 추출하여 genStudent 에 전달하게 만들어주면 된다.
	...
	var gender = document.getElementById("id_input_gender");
...
function f6(){
	...
	element.innerHTML ="HTML 태그 객체 생성하여 추가";
	...
	tag += "background-color:" + square.color + ";'>HTML 태그를 문자열로 만들어 innerHTML에 설정</div>" 
	res6.innerHTML = tag;
	
	res6.innerHTML = "<div style='display:inline-block; width:200px,height:200px;background-color:#00FF00;'>"
				   + "HTML태그를 문자열로 만들어 innerHTML에 설정</div>";
	/*
