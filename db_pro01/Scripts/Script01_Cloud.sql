...
CREATE USER puser1 IDENTIFIED BY Kangsl4913112;
...
SELECT * FROM DBA_USERS WHERE USERNAME = 'PUSER1';
ALTER USER puser1 ACCOUNT UNLOCK;
ALTER USER puser1 IDENTIFIED BY Kangsl4913112;
