...
SELECT *
	...
	--WHERE TO_CHAR(HIRE_DATE, 'YYYY"년" MM"월" DD"일"') <= '1999년 12월 31일'
	--AND TO_CHAR(HIRE_DATE + INTERVAL '60' MONTH) <= '1999년 12월 31일';
...
SELECT *
	...
	--WHERE TO_CHAR(HIRE_DATE, 'YYYY"년" MM"월" DD"일"') <= '1999년 12월 31일'
	--AND TO_CHAR(HIRE_DATE + INTERVAL '7' YEAR) <= '1999년 12월 31일';
